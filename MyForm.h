...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	label1->Text = "\n Кол-во шагов: " + System::Convert::ToString(index) +
		...
		"\n Невязка СЛАУ на нач. приближении R(0): " + System::Convert::ToString(MaxF) +
		"\n Невязка СЛАУ на выходе R(p): " + System::Convert::ToString(abs(temp2));
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	label1->Text = "\n Кол-во шагов v2: " + System::Convert::ToString(index) +
		...
		"\n Параметр Tau: " + System::Convert::ToString(tau) +
		"\n Время: " + System::Convert::ToString((c_end - c_start) / CLOCKS_PER_SEC) + "s\n" +
		"\n Невязка СЛАУ на нач. приближении R(0) v2: " + System::Convert::ToString(MaxF) +
		"\n Невязка СЛАУ на нач. приближении R(0) v22: " + System::Convert::ToString(MaxF2) +
		"\n Невязка СЛАУ на выходе R(p): v2 " + System::Convert::ToString(abs(temp2)) +
		"\n Невязка СЛАУ на выходе R(p): v22 " + System::Convert::ToString(abs(temp22));
}
